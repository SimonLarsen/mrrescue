...
local IMAGE_FILES = {
	...
	"gasleak_idle", "gasleak_hit", "gasleak_walk", "gasleak_rage_walk",
	"gasleak_transition", "gasleak_portrait",
...
WON_MESSAGES = {
	...
	{"CONGRATULATIONS!","","YOU HAVE BEATEN MR. MAGMA HULK","AND RESCUED THE APARTMENT COMPLEX",
	 "","NOW TRY TO RESCUE","THE BIG CORPORATION!","","PRESS RETURN TO CONTINUE"},
	{"CONGRATULATIONS!","","YOU HAVE BEATEN MR. MAGMA HULK","AND RESCUED THE BIG CORPORATION",
